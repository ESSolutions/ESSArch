...
def installSubmissionAgreement():
    ...
    dct = {
        'name': 'SA Single Records Archive X and Organization X',
        'published': True,
        'type': 'Standard',
        'status': 'Agreed',
        'label': 'SA Single Records Archive X and Organization X',
        'policy': policy,
...
def installProfileContentType(sa):
    ...
    dct = {
        'name': 'Content Type profile SE (Single Records)',
