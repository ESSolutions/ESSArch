...
def installSubmissionAgreement():
    ...
    dct = {
        'name': 'FRS Digital Archiving',
        'published': True,
        'type': 'Standard',
        'status': 'Agreed',
        'label': 'FRS Digital Archiving',
        'policy': policy,
...
def installProfileSIP(sa):
    ...
    dct = {
        'name': 'SIP SE (FRS Digital Archiving)',
        'profile_type': 'sip',
        'type': 'Implementation',
        'status': 'Draft',
        ...
        'template': [
            {
                "key": "mets_type",
                "type": "select",
                "defaultValue": "Single records",
                "ngModelElAttrs": {
                    'uib-popover': "Ange vilken informationstyp den överförda informationen tillhör. "
                                   "En SIP kan tillhöra en och endast en informationstyp.",
            ...
            },
            {
                "templateOptions": {
                    "type": "text",
                    "label": "Arkivets referenskod"
                },
                "ngModelElAttrs": {
                    'uib-popover': "Referenskod i arkivredovisningen.",
                    'popover-placement': 'bottom',
                    'popover-trigger': "\'mouseenter\'"
                },
                "type": "input",
            ...
            },
            {
                "templateOptions": {
                    "type": "text",
                    "label": "Levererande System ",
                    "disabled": True,
                },
                "ngModelElAttrs": {
                    'uib-popover': "Det system som skapat SIP:en",
                    'popover-placement': 'bottom',
                    'popover-trigger': "\'mouseenter\'"
                },
                "type": "input",
            ...
            },
            {
                "templateOptions": {
                    "disabled": True,
                    "type": "text",
                    "label": "Levererande System Version"
                },
                "type": "input",
        ...
        'specification': json.loads(open(
            os.path.join(settings.BASE_DIR, 'templates/se/SE_SIP_SINGLE_RECORDS_VERSION11.json')
        ).read()),
    }
...
def installProfileAIP(sa):
    ...
    dct = {
        'name': 'AIP SE (FRS Digital Archiving)',
        'profile_type': 'aip',
        'type': 'Implementation',
        'status': 'Draft',
...
def installProfileContentType(sa):
    ...
    dct = {
        'name': 'Content Type profile SE (Treserva)',
        'profile_type': 'content_type',
        'type': 'content_type',
        'status': 'Draft',
        'label': 'Content Type profile SE (Treserva',
        'specification': {
            'name': 'treserva'
        }
    }
...
def installProfileWorkflow(sa):
    ...
    dct = {
        'name': 'TRESERVA Workflow SE',
        'profile_type': 'workflow',
        'specification': json.loads(open(os.path.join(settings.BASE_DIR, 'templates/se/TRESERVA_SE_WORKFLOW.json')).read()),
    }
