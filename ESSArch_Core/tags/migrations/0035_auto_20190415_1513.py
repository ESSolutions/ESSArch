...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='template',
            field=models.ForeignKey(limit_choices_to={'is_template': True}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='instances', to='tags.Structure', verbose_name='template'),
        ),
        migrations.AlterField(
