    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lft', models.PositiveIntegerField(db_index=False, editable=False)),
                ('rght', models.PositiveIntegerField(db_index=False, editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=False, editable=False)),
