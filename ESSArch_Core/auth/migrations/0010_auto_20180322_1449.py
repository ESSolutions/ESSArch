    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(blank=True, default=b'', max_length=255)),
                ('properties', jsonfield.fields.JSONField(blank=True, default={})),
                ('django_auth_sync', models.BooleanField(default=True)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_essauth_group_set', to='essauth.Group')),
                ...
                ('group_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='essauth_groups', to='groups_manager.GroupType')),
            ],
            options={
                'ordering': ('name',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default=b'', max_length=255)),
                ('django_auth_sync', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_membership', to='essauth.Group')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='group_membership', to='essauth.Member')),
                ('roles', models.ManyToManyField(related_name='group_memberships', to='groups_manager.GroupMemberRole')),
            ],
            options={
