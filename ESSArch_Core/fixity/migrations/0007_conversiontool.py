    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('APP', 'Application'),
                                                   ('DOCKER_IMG', 'Docker Image')], max_length=20, verbose_name='type')),
                ...
                ('form', models.JSONField(blank=True, null=True, verbose_name='form')),
            ],
            options={
