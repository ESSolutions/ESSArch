...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='actiontool',
            name='form',
            field=ESSArch_Core.fields.JSONField(blank=True, default='[\n        {\n            "key": "path",\n            "type": "input",\n            "templateOptions": {\n                "label": "PATH_i18n",\n                "required": true\n            },\n            "expressionProperties":{\n                "templateOptions.label":"\\"PATH\\" | translate"\n            }\n        }\n]', null=True, verbose_name='form'),
        ),
        migrations.AlterField(
            model_name='actiontool',
            name='type',
            field=models.CharField(choices=[('conversion', 'Conversion Tool'), ('collection', 'Collection Tool'), ('transformation', 'Transformation Tool'), ('validation', 'Validation Tool')], max_length=20, verbose_name='type'),
        ),
    ]
