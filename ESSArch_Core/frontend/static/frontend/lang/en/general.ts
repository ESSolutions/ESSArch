...
const general = ($translateProvider) => {
  $translateProvider.translations('en', {
    ...
    CREATE_DELIVERY: 'Create accession',
    CREATE_DELIVERY_DESC: 'Do you want to create a accession?',
    ...
    LOCK: 'Lock',
    LOCK_SA_TO_DELIVERY: 'Lock submission agreement to accession',
    LOCK_SA_TO_IP: 'Lock submission agreement to accession',
    LOCKED: 'Locked',
    ...
    MANAGE_DELIVERY: 'Manage accession',
    ...
    MIGRATE: 'Migrate',
    MIGRATE_ALL_METHODS: 'Migrate to all storage methods',
    ...
    PREPARE_DELIVERY: 'Prepare accession',
    PREPARE_DELIVERY_DESC: 'Have you prepared the accession?',
    PREPARE_FOR_NEW_DELIVERY: 'Prepare for a new accession',
    PREPARE_IP_DESC: 'Do you want to prepare IP(s) for upload?',
    PREPARE_IP: 'Prepare IP',
    PREPARE_NEW_DELIVERY: 'New accession',
    ...
    PROCESS: 'Process',
    PROCESS_AS_EDITABLE: 'Process in edit mode',
    PROCESS_AS_CONTAINER: 'Process as container',
    PROCESS_AS_NEW_GENERATION: 'Process as new generation',
    PROCESS_AS_READ_ONLY: 'Process as read only',
    PRODUCER: 'Producer',
    PROFILE: 'Profile',
    ...
    READ_ONLY: 'Read only',
    RECEIVE_DELIVERY: 'Receive accession',
    RECEIVE_DELIVERIES: 'Receive accessions',
    ...
    RETRY: 'Retry',
    RETRIEVE: 'Retrieve',
    RETRIEVE_AS_CONTAINER: 'Retrieve as container',
    RETRIEVE_AS_NEW_GENERATION: 'Retrieve as new generation',
    RETRIEVE_AS_READ_ONLY: 'Retrieve as read only',
    RETRIEVE_AS_UNPACKED: 'Retrieve as unpacked',
    REVOKE: 'Stop',
    REVOKED: 'Stopped',
    ...
    SUBMIT: 'Submit',
    SUBMIT_DELIVERY: 'Submit accession',
    SUBMIT_DELIVERY_DESC: 'Do you want to submit the accession?',
