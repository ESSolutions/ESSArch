...
const general = ($translateProvider) => {
  $translateProvider.translations('en', {
    ...
    APPRAISAL_DATE_DESC: 'Destruction date',
    APPRAISAL_DATE: 'Destruction date',
    ...
    CREATE_DELIVERY_DESC: 'Do you want to create a delivery?',
    CREATE_SIP_DESC: 'Do you want to create SIP(s) from IP(s)?',
    CREATE_SIP: 'Create SIP',
    CREATE_TEMPLATE: 'Create template',
    CREATE_NEW_GENERATION: 'Create new generation',
    CREATE: 'Create',
    CREATED: 'Created',
    ...
    LOCK: 'Lock',
    LOCK_SA_TO_DELIVERY: 'Lock submission agreement to delivery',
    LOCK_SA_TO_IP: 'Lock submission agreement to delivery',
    LOCKED: 'Locked',
    ...
    MIGRATE: 'Migrate',
    MIGRATE_ALL_METHODS: 'Migrate to storage methods',
    ...
    MOVE_TO_INGEST_CHECKPOINT: 'Move to Ingest/Checkpoint',
    MY_PAGE: 'My page',
    MYPAGE: 'My page',
    NAME: 'Name',
    ...
    PREPARE_DELIVERY_DESC: 'Have you prepared the delivery?',
    PREPARE_FOR_NEW_DELIVERY: 'Prepare for a new delivery',
    PREPARE_IP_DESC: 'Do you want to prepare IP(s) for upload?',
    PREPARE_IP: 'Prepare IP',
    PREPARE_NEW_DELIVERY: 'New delivery',
    ...
    PROCESS: 'Process',
    PROCESS_AS_EDITABLE: 'Move to workspace for processing',
    PROCESS_AS_CONTAINER: 'Process as container',
    PROCESS_AS_NEW_GENERATION: 'Create a new generation in workspace',
    PROCESS_AS_READ_ONLY: 'Get a reading copy in workspace',
    PRODUCER: 'Producer',
    PROFILE: 'Profile',
    ...
    RECEIVE_DELIVERIES: 'Receive deliveries',
    ...
    RECEIVE_INFORMATION_PACKAGES: 'Receive information packages',
    ...
    RETRY: 'Retry',
    RETRIEVE: 'Retrieve',
    RETRIEVE_AS_CONTAINER: 'Retrieve as container to workspace',
    RETRIEVE_AS_NEW_GENERATION: 'Retrieve as new generation',
    RETRIEVE_AS_UNPACKED: 'Retrieve as unpacked to workspace',
    REVOKE: 'Stop',
    REVOKED: 'Stopped',
    ...
    STORAGE_METHODS: 'Storage methods',
    ...
    SUBMIT_DELIVERY_DESC: 'Do you want to submit the delivery?',
    ...
    UPDATE: 'Update',
    UPDATE_INITIAL_VALUES_DESC: 'Lock the forms current state',
    UPDATED_INITIAL_VALUES_NOTIFICATION: 'Updated initial form values',
