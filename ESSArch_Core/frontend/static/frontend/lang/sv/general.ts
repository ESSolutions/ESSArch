...
export default ($translateProvider: ng.translate.ITranslateProvider) => {
  $translateProvider.translations('sv', {
    ...
    MIGRATE: 'Migrera',
    MIGRATE_ALL_METHODS: 'Migrera till samtliga lagringsmetoder',
    ...
    PROCESS: 'Bearbeta',
    PROCESS_AS_EDITABLE: 'Bearbeta som editerbar',
    PROCESS_AS_CONTAINER: 'Bearbeta som en "container"',
    PROCESS_AS_NEW_GENERATION: 'Bearbeta som en ny generation',
    PROCESS_AS_READ_ONLY: 'Bearbeta som "read only"',
    PRODUCER: 'Producent',
    PROFILE: 'Profil',
    ...
    RESULT: 'Resultat',
    RETRIEVE: 'Hämta',
    RETRIEVE_AS_CONTAINER: 'Hämta som "container"',
    RETRIEVE_AS_NEW_GENERATION: 'Hämta som ny generation',
    RETRIEVE_AS_READ_ONLY: 'Hämta som "read only"',
    RETRIEVE_AS_UNPACKED: 'Hämta som uppackad',
    RETRY: 'Försök igen',
    REVOKE: 'Stoppa',
    REVOKED: 'Stoppad',
