...
export default ($translateProvider: ng.translate.ITranslateProvider) => {
  $translateProvider.translations('sv', {
    ACCESS: {
      ...
      CREATOR_END_DATE: 'Arkivbildarens slutdatum',
      CREATOR_END_YEAR: 'Arkivbildarens slutår',
      CREATOR_START_DATE: 'Arkivbildarens startdatum',
      ...
      RELATED_ARCHIVE_CREATORS_DESC: 'Den arkivbildare som nämns i tabellen relaterade arkivbildare är t.ex. föregångare till den arkivbildare som visas i presentationsvyn.',
      RELATED_RESOURCES: 'Relaterade arkiv',
      RELATED_RESOURCES_DESC: 'Den arkivbildare som visas i presentationsvyn är arkivbildare/arkivansvarig till de arkiv som visas i tabellen under ”relaterade arkiv”.',
