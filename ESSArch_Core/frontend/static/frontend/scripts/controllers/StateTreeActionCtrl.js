...
export default class StateTreeActionCtrl {
  constructor(
    $scope,
    $translate,
    Step,
    ...
    $scope.getTask = function (branch) {
      ...
      return Task.get({id: branch.id}).$promise.then(function (data) {
        ...
        //Remove step tasks where it's not an action
    ...
    $scope.statusViewUpdate = function (row) {
      ...
      return StateTree.getTreeActionData(row, expandedNodes).then(function (value) {
