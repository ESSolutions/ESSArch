export default class AgentCtrl {
  constructor(
    ...
    vm.archiveClick = function (agentArchive) {
      $state.go('home.archivalDescriptions.archiveManager.detail', {id: agentArchive.archive._id});
    };

    vm.searchClick = function (agentArchive) {
      $state.go('home.archivalDescriptions.search.component', {id: agentArchive.archive._id});
    };
    ...
    vm.agentArchivePipe = function (tableState) {
      ...
      if (!angular.isUndefined(tableState)) {
        ...
        const sorting = tableState.sort;
        const paginationParams = listViewService.getPaginationParams(tableState.pagination, vm.agentsPerPage);
    ...
    vm.addHistoryModal = function () {
      const modalInstance = $uibModal.open({
        ...
        ariaLabelledBy: 'modal-title',
        ariaDescribedBy: 'modal-body',
        templateUrl: 'static/frontend/views/add_agent_history_modal.html',
        controller: 'AgentNoteModalInstanceCtrl',
        controllerAs: '$ctrl',
        size: 'lg',
        resolve: {
    ...
    vm.editHistoryModal = function (note) {
      const modalInstance = $uibModal.open({
        ...
        ariaLabelledBy: 'modal-title',
        ariaDescribedBy: 'modal-body',
        templateUrl: 'static/frontend/views/edit_agent_history_modal.html',
        controller: 'AgentNoteModalInstanceCtrl',
        controllerAs: '$ctrl',
        size: 'lg',
        resolve: {
    ...
    vm.removeHistoryModal = function (note) {
      const modalInstance = $uibModal.open({
        ...
        ariaLabelledBy: 'modal-title',
        ariaDescribedBy: 'modal-body',
        templateUrl: 'static/frontend/views/remove_agent_history_modal.html',
        controller: 'AgentNoteModalInstanceCtrl',
        controllerAs: '$ctrl',
        size: 'lg',
        resolve: {
