export default class IpConversionJobModalInstanceCtrl {
  constructor($uibModalInstance, $translate, data, $http, appConfig, Search) {
    ...
    $ctrl.getJobs = (search) => {
      return $http
        .get(appConfig.djangoUrl + 'conversion-jobs/', {params: {search, status: 'PENDING'}})
        .then((response) => {
    ...
    $ctrl.addToJob = function () {
      ...
      $http
        .patch(appConfig.djangoUrl + 'conversion-jobs/' + $ctrl.model.job + '/information-packages/', {
