  ...
  constructor(
    ...
    vm.editModal = function (aid) {
      const modalInstance = $uibModal.open({
        ...
        templateUrl: 'static/frontend/views/edit_search_aid_modal.html',
    ...
    vm.eraseModal = function (aid) {
      const modalInstance = $uibModal.open({
        ...
        ariaLabelledBy: 'modal-title',
        ariaDescribedBy: 'modal-body',
        templateUrl: 'static/frontend/views/erase_search_aid_modal.html',
    ...
    vm.createModal = function () {
      const modalInstance = $uibModal.open({
        ...
        ariaLabelledBy: 'modal-title',
        ariaDescribedBy: 'modal-body',
        templateUrl: 'static/frontend/views/add_search_aid_modal.html',
