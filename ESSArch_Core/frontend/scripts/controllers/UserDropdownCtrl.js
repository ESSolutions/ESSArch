angular.module('essarch.controllers').controller('UserDropdownCtrl', function ($scope, $log, $rootScope, $state, djangoAuth, $window, $translate, $uibModal) {
